...
public class CustomerOrderRegister2 extends JPanel implements ActionListener {
	...
	private void initComponents() {
		...
		pOrderRegi.setBounds(0, 0, 1184, 338);
		add(pOrderRegi);
		...
		btnRewrite.setBounds(868, 300, 97, 23);
		pOrderRegi.add(btnRewrite);

		btnCancel = new JButton("취소");
		btnCancel.addActionListener(this);
		btnCancel.setBounds(977, 300, 97, 23);
		...
		lblUp = new JLabel("닫기");
		lblUp.setIcon(new ImageIcon("D:\\D\\workspace\\workspace_java\\it_3st_3team\\resources\\arrowup.png"));
		lblUp.setBounds(272, 139, 120, 15);
		pOrderRegi.add(lblUp);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(272, 164, 531, 117);
		pOrderRegi.add(scrollPane);
	...
	public void setEventListener(EventListener listener) {
		if(listener instanceof MouseListener) {
			lblUp.addMouseListener((MouseListener)listener);
		}
	}
