...
public class AdminManagementRegister extends JPanel {
	...
	private void initComponents() {
		...
		panel_1.setBounds(12, 10, 180, 230);
		panel_1.setLayout(new BorderLayout(0, 0));
		add(panel_1);
		
		JLabel label_6 = new JLabel("");
		label_6.setIcon(new ImageIcon("D:\\workspaces\\workspace_java\\it_3st_3team\\DataImg\\xiaomi.png"));
		label_6.setHorizontalAlignment(SwingConstants.CENTER);
		panel_1.add(label_6, BorderLayout.CENTER);
