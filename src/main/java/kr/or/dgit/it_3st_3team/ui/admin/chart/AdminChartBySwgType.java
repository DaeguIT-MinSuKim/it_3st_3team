...
public class AdminChartBySwgType extends JPanel  {

	private JFreeChart chart;
	private SaleOrderService saleOrder;
	
	
	public AdminChartBySwgType() {
	...
	private CategoryDataset createDataset() {
		...
		maps1.put("date", "2016");
		List<Map<String, Integer>> listChart1 = saleOrder.selectSwGroupBySales(maps1);
		
		Map<String, String> maps2 = new HashMap<>();
		maps2.put("adminName", "영업1");
		maps2.put("date", "2017");
		List<Map<String, Integer>> listChart2 = saleOrder.selectSwGroupBySales(maps2);
		
		Map<String, String> maps3 = new HashMap<>();
		maps3.put("adminName", "영업1");
		maps3.put("date", "2018");
		List<Map<String, Integer>> listChart3 = saleOrder.selectSwGroupBySales(maps3);
