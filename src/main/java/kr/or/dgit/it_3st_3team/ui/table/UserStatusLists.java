...
public class UserStatusLists extends JPanel {
	...
	private Object[][] getRows() {
		...
		return new Object[][] {
			{"1", "게임", "오버워치", "1", "계좌이체", "100,000원", "2018-02-23"},
			{"2", "게임", "오버워치", "5", "계좌이체", "100,000원", "2018-02-23"},
			{"3", "게임", "오버워치", "3", "계좌이체", "100,000원", "2018-02-23"}
		};
	}

	public String[] getColumNames() {

		return new String[] { "번호", "분류", "품목명", "주문수량", "결제수단","총가격","날짜"};
	}
	...
	private void setAlignWidth() {
		...
		tableCellWidth(200, 300, 500, 200, 400, 500, 500);
